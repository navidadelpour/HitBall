...
public class SpeedManager : MonoBehaviour {
	...
	private Dictionary<string, float> game_min_speed = new Dictionary<string, float>() {{"min", 6f}};
	private Dictionary<string, float> game_max_speed = new Dictionary<string, float>() {{"min", 12f}};
	...
	private Dictionary<string, float> player_max_speed = new Dictionary<string, float>() {{"min", 16f}};
